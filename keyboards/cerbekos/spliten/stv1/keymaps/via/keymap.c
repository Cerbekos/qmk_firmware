...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+|
        KC_LPRN, _______, _______, _______,  S_SCLN,  KC_EQL,          KC_PPLS, KC_PMNS, KC_PAST, KC_PSLS, _______, KC_RPRN,
    //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+|
  ...
  [3] = LAYOUT(
    //|--------------------------------------------------------------+------------------------------------------------------'
          KC_P7,   KC_P8,   KC_P9, KC_NLCK, _______, _______,           KC_F24, _______, _______, KC_LBRC, KC_RBRC, _______,
    //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+|
          KC_P4,   KC_P5,   KC_P6, TD_PMNS, _______, _______,          RGB_MOD, RGB_VAI, RGB_HUI, KC_QUOT, KC_NUHS, _______,
    //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+|
          KC_P1,   KC_P2,   KC_P3, TD_PLUS, _______, _______,         RGB_RMOD, RGB_VAD, RGB_HUD, KC_SCLN,   KC_UP, _______,
    //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+|
          KC_P0,  TD_DOT, KC_COMM,   RESET, _______, _______,          _______, _______,   DF(0), KC_LEFT, KC_DOWN, KC_RGHT,
    //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+|
