...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        C_TAB,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_MINS,
    ...
    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, RGB_HUI, _______, _______, QK_BOOT,
        CW_TOGG, _______, _______, _______, _______, _______, _______, RGB_MOD, RGB_HUD, RGB_RMOD, _______,
    ...
    [3] = LAYOUT(
        ...
        KC_LALT, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC,
