...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS, KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, KC_DEL,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,        
        C_CAPS,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_SCLN, KC_QUOT, KC_H,    KC_J,    KC_K,    KC_L,    KC_MINS,                  
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  S_SLSH,                  
        KC_LCTL, KC_LGUI, KC_LALT, L3_SPC,  KC_LEFT,  KC_UP,  KC_DOWN, KC_RGHT, L1_ENT,  L2_MENU, KC_RGUI, KC_RCTL,
        KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
        KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
        KC_P4,   KC_P5,   KC_P6, 
        KC_P1,   KC_P2,   KC_P3,    L1_ENT,
        KC_P0,            KC_PDOT,          KC_VOLU, KC_VOLD
    ),
    [1] = LAYOUT(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F11,  KC_F12,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                  
        _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______,                  
        _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______, _______, _______, _______,
        _______, _______, _______, QK_BOOT,
        _______, _______, _______, KC_BSPC,
        _______,  KC_EQL,  S_SCLN,
        _______, _______,  S_MINS, _______,
        _______,          KC_COMM,         _______, _______
    ),
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                  
        _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______,                  
        _______, _______, _______, _______, RGB_MOD, RGB_HUI, RGB_HUD,RGB_RMOD, _______, _______, _______, _______,
    ...
    [3] = LAYOUT(
        ...
        _______, _______, _______, _______, _______,  KC_F10, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC,                  
        _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______,                  
        _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______, _______, _______, _______,
        _______, _______, _______, _______,
        _______, _______, _______, _______,
